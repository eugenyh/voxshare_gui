...
pyinstaller --onefile --noconsole --icon=Icons/logo.ico --add-data="Icons/logo.png;Icons" --add-data="Icons/settings_icon.png;Icons" --hidden-import=customtkinter  --add-binary="opus.dll;." "%PYTHON_SCRIPT%"
